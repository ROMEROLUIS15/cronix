  ...
  if (logs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center space-y-3 opacity-50">
        ...
        <p className="text-sm font-medium">No dead letters found in the queue.</p>
        <p className="text-[12px]">All systems are processing normally.</p>
      </div>
    );
  }
              ...
              <td className="px-5 py-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-red-200 uppercase tracking-tight">
                    {log.error_reason || 'Unknown failure'}
                  </span>
                </div>
              </td>
