/**
 * instrumentation-client.ts — Sentry client-side initialization (Next.js 15+)
 *
 * Replaces the legacy sentry.client.config.ts pattern.
 * Next.js 15 auto-discovers this file and injects it before app code runs.
 * This is the recommended approach for Turbopack compatibility and faster cold starts.
 *
...
// ── Next.js 15 App Router navigation instrumentation ──────────────────────────
// Captures navigation errors (client-side transitions) that bypass error boundaries.
